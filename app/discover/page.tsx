        ...
        events.map((event: EventItem) => (
          <section key={event.id} className={styles.eventRow}>
            <div className={styles.detailsPanel}>
              ...
              <p>
                <strong>Location:</strong> {event.venue.city},{' '}
                {event.venue.state}
              </p>
              <p>
                <strong>Tickets:</strong> {event.cheapestTicket}
              </p>
              <p>
                <strong>Parking:</strong> {event.parkingInfo}
              </p>
              {event.cheapestTicket !== 'Tickets not on sale' &&
                event.cheapestTicket !== 'Price TBA' && (
                  <a
              ...
              {(
                ...
                <p>
                  <strong>Directions:</strong> Directions unavailable
                </p>
              )}
            </div>
